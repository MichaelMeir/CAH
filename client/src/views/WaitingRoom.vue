<template>
  <div>
          ...
          <div class="p-5 mt-20">
            <div class="h-full flex justify-center items-center relative">
              <div class="w-1/3 bg-white p-10 pb-4 rounded shadow">
                <div @click="leaveModal = false" class="flex flex-1 justify-end -m-5">
                  <svg data-v-a1fbe5b4="" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 cursor-pointer"><path data-v-a1fbe5b4="" d="M10 8.586L2.929 1.515 1.515 2.929 8.585 10l-7.07 7.071 1.414 1.414L10 11.415l7.071 7.07 1.414-1.414L11.415 10l7.07-7.071-1.414-1.414L10 8.585z" fill-rule="evenodd" class="close"></path></svg>
                </div>
                <h1 class="mt-6 text-3xl">Are you sure you want to leave?</h1>
                <p class="font-thin">You are about to leave your room. If you leave you will lose all your points</p>
                <div class="flex border-t mt-4">
                  <div class="flex flex-1 justify-end mt-4">
                    <button class="text-sm bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none transition mr-4" @click="leaveRoom">Yes</button>
                    <button class="text-sm bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none transition" @click="leaveModal = false">No take me back</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="max-w-4xl mx-auto mt-1 flex">
      <div class="flex-1">
        <button @click="leaveModal = true" class="bg-indigo-700 hover:bg-indigo-800 text-white font-bold py-2 px-4 mr-2 rounded">Leave</button>
